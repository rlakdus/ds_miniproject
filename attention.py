...
class BertSelfAttention(nn.Module):
    ...
    """
    def __init__(self, config: MedConfig, is_cross_attention: bool = False):
        super().__init__()
        ...
        # K/V: cross-attention이면 이미지 차원, 아니면 텍스트 차원
        kv_dim = config.encoder_width if is_cross_attention else config.hidden_size
